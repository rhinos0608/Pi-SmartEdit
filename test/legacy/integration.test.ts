...
import { applyEdits, lineRangeToByteRange } from "../../src/core/edit-diff";
...
async function testConflictDetectorFlow() {
  const { createConflictDetector, defaultConflictConfig } = await import('../../src/core/conflict-detector');
